...
def validate(model, T_obs, T_pred, file, model_type='v'):
    ...
    for batch_idx, data in enumerate(dataset):
        ...
        coords = data['coords']
        print("cuda_test:")
        print("input_seq:",input_seq.is_cuda)
        print("coords:",coords.is_cuda)
        print("part_masks:",part_masks.is_cuda)
        print("h:",h.is_cuda)
        print("c:",c.is_cuda)
        print("Y:",Y.is_cuda)
...
# python main.py mode --dataset "eth" --pure_val_name "trained_models//s_eth.pt" --T_obs 8 --T_pred 20
# python main.py mode --dataset "eth" --pure_val_name "trained_models//s_eth.pt" --T_obs 0 --T_pred 20
# python main.py mode --dataset "highD" --pure_val_name "trained_models//s_eth.pt" --T_obs 0 --T_pred 20
def main():
    #set device
    global device
...
# python main.py "s" --dataset "highd" --epoch 1
# python main.py "s" --dataset "ngsim" --epoch 1